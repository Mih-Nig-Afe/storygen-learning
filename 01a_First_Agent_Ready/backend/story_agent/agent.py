  ...
  "scenes": [
    {
      "index": 1,
      "title": "The Setup",
      "description": "Scene action and setting description for image generation. Focus on lighting, mood, and surroundings. DO NOT repeat character details here.",
...
# Define tools list (explicitly empty as per design)
tools = []
